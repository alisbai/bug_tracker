                ...
                <div className='pr-4 pl-4'>
                    ...
                    <nav>
                        <ul>
                            ...
                            {(roles.includes("Admin") || roles.includes("Project Manager"))&& <li><SidebarItem title="Manage Projects Staff" icon={faUsers} routeFunc={route} route={route("manageProjectsStaff.get")}/></li>}
