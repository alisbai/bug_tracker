...
export default function Authenticated({ auth, children }) {
    ...
    return (
        <div className="flex h-screen min-h-screen bg-gray-100">
            ...
            <div className='flex flex-col side-bar w-60 bg-sidebar-navy pt-9'>
                <div className='pr-4 pl-4'>
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><SidebarItem title="Dashboard" icon={faGauge} routeFunc={route} route={route("origin")} /></li>
                            ...
                            <li><SidebarItem title="Settings" icon={faGears}  routeFunc={route} route={route("origin")}/></li>
                        </ul>
                    </nav>
                </div>
